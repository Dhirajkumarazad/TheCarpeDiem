        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    ...
                    Toast.makeText(PhoneLogin.this, "Too many requests right now to processed! Try again later..", Toast.LENGTH_SHORT).show();
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (e2.getText().toString().equals(""))
                    Toast.makeText(PhoneLogin.this, "Please enter Code. It can't be left empty!", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            startActivity(new Intent(PhoneLogin.this,Login.class));
